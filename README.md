...
| [issue-workflows](plugins/issue-workflows/) | Commands | `/issue-workflows:setup`, `:file`, `:epic`, `:status` — convention-based GitHub issues, and cross-repo epics on one Projects v2 board |
