...
3. **Check authentication:**
   ...
   - If the output shows a logged-in account, local credentials are present. Note this is a local check — it can't detect server-side auth failures; the first real `codex exec` call is the true probe.
