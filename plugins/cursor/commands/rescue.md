...
```bash
agent -p --mode plan --model cursor-grok-4.5-high <<'CURSOR_TASK_9f3a2b1c'
<task text>
CURSOR_TASK_9f3a2b1c
```
...
- `--model <id>`: use it in place of `cursor-grok-4.5-high`. There is no `--effort` flag — reasoning level is part of the model id.
