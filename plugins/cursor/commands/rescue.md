...
```bash
agent -p --mode plan --model gpt-5.6-sol-high <<'CURSOR_TASK_9f3a2b1c'
<task text>
CURSOR_TASK_9f3a2b1c
```
...
- `--model <id>`: use it in place of `gpt-5.6-sol-high`. There is no `--effort` flag — reasoning level is part of the model id.
