...
5. **Mention discovery:** the default model used by this plugin's commands is `cursor-grok-4.6-high`; run `agent --list-models` to see all available model ids that can be passed with `--model`.
